    ...
    <div class="grid">
            ...
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-900 font-medium text-xl">S/42,100.10</div>
                    </div>
        ...
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                ...
                <span class="text-500">nuevos registrado</span>
            </div>
        </div>
        <div class="col-12 lg:col-6 xl:col-3">
            <div class="card mb-0">
                <div class="flex justify-content-between mb-3">
                    <div>
                        ...
                        <div class="text-900 font-medium text-xl">2 no leídos</div>
                    </div>
                ...
                <span class="text-500">respondieron</span>
            </div>
        </div>

        <div class="col-12 xl:col-6">
            <div class="card">
                <h5>Ventas total por campañas</h5>
                <DataTable :value="products" :rows="5" :paginator="true" responsiveLayout="scroll">
                    ...
                    <Column field="price" header="Monto" :sortable="true" style="width: 35%">
                        <template #body="slotProps">
            ...
            <div class="card">
                ...
                <ul class="list-none p-0 m-0">
                    <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <div>
                            <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sede Miraflores</span>
                            <div class="mt-1 text-600">Claudia</div>
                        </div>
                    ...
                    <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <div>
                            <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sede San Borja</span>
                            <div class="mt-1 text-600">Luis</div>
                        </div>
                    ...
                    <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <div>
                            <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sede La Molina</span>
                            <div class="mt-1 text-600">Banesa</div>
                        </div>
                        <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                            <div class="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style="height: 8px">
                    ...
                    <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <div>
                            <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sede San Miguel</span>
                            <div class="mt-1 text-600">Erika</div>
                        </div>
                        <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                            <div class="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style="height: 8px">
                    ...
                    <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <div>
                            <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sede Lima</span>
                            <div class="mt-1 text-600">Katty</div>
                        </div>
                        <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                            <div class="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style="height: 8px">
                    ...
                    <li class="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                        <div>
                            <span class="text-900 font-medium mr-2 mb-1 md:mb-0">Sede Chorrillos</span>
                            <div class="mt-1 text-600">Fiorella</div>
                        </div>
                        <div class="mt-2 md:mt-0 ml-0 md:ml-8 flex align-items-center">
                            <div class="surface-300 border-round overflow-hidden w-10rem lg:w-6rem" style="height: 8px">
