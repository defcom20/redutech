            ...
            <div class="card">
                <Toolbar class="mb-2">
                    <template v-slot:start>
                        <div>
                            <Button label="Nuevo Cliente" icon="pi pi-plus" class="mr-2" severity="success"
                                @click="openNew" />
                ...
                <Dialog v-model:visible="productDialog" :style="{ width: '750px' }" header="Nuevo Cliente" :modal="true"
                    class="p-fluid">
                    ...
                    <div class="formgrid grid">
                        <div class="field col">
                            <label for="name2">Buscar por DNI</label>
